...
import { Loader2, Save, Globe, Image as ImageIcon, Sparkles, ChevronLeft } from "lucide-react";
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-xl font-bold tracking-tight">Edit Artikel</h1>
                  <span className="text-zinc-300 dark:text-zinc-700">/</span>
                  <span className="text-sm font-medium text-emerald-600">#{id}</span>
                </div>
              </div>
            </div>
