      ...
      <div className="relative z-10 container px-4 sm:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="relative h-12 w-12 overflow-hidden rounded-full border-2 border-emerald-500 shadow-lg">
                <Image src="/logo.png" alt="K3 Arafah Logo" fill className="object-cover" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white">K3 Arafah</h3>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium text-slate-100">Alamat</p>
        ...
        >
          <p className="text-sm text-emerald-100/50">
            &copy; {new Date().getFullYear()} K3 Arafah. {t("rights_reserved")}
          </p>
